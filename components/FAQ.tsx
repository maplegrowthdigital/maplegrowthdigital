...
const FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    a:
      "Four options: a small-business starter plan, fixed-scope sprints, monthly retainers, or custom engagements. Starter plans begin at $500/month, sprints at $1.5K, and retainers at $1K/month. We share specific scope and pricing on the discovery call — no surprises later.",
  },
];
